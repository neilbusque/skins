...
export const skins: SkinMeta[] = [
  ...
  },
  {
    id: 'atelier',
    name: 'Atelier',
    archetype: 'Cinematic Bands',
    swipeRef: '',
    useFor: 'Photography led. Hospitality, property, studio, anything selling atmosphere.',
    swatches: ['#14120F', '#C9A227', '#F0EBE3'],
    cardBg: '#14120F',
    cardFg: '#F0EBE3',
    cardMuted: '#948C80',
    cardAccent: '#C9A227',
    cardFont: "'Bodoni Moda', Georgia, serif",
    cardWeight: '600',
    cardTracking: '-0.028em',
  },
  {
    id: 'lookbook',
    name: 'Lookbook',
    archetype: 'Editorial Masonry',
    swipeRef: '',
    useFor: 'Photography led. Portfolio, agency work, fashion, a body of work to show.',
    swatches: ['#F6F5F1', '#101010', '#EBE9E3'],
    cardBg: '#F6F5F1',
    cardFg: '#101010',
    cardMuted: '#6A6862',
    cardAccent: '#101010',
    cardFont: "'Syne', system-ui, sans-serif",
    cardWeight: '800',
